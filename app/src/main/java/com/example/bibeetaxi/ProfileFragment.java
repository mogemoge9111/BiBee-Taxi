...
public class ProfileFragment extends Fragment {
    ...
    private void saveUserData() {
        ...
        if (name.isEmpty() || surname.isEmpty()) {
            Toast.makeText(getContext(), "Заполните имя и фамилию", Toast.LENGTH_SHORT).show();
            return;
        }

        db.collection("users").document(currentUserId)
                .set(new UserProfile(name, surname, mAuth.getCurrentUser().getEmail(), "passenger"), SetOptions.merge())
    ...
    public static class UserProfile {
        public String name, surname, email, userType;
        public UserProfile() {}
